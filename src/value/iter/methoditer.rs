...
use crate::{Context, Error, UnaryOp};
...
pub struct MethodIter {
    ...
    pub index_op: UnaryOp,           // Operation on index to increase or decrease
}

impl MethodIter {
    /// Creates a new iterator on object, with default "get_item"-method and "iinc"-operation.
    pub fn new(object: RefValue) -> Iter {
        Self::new_method_iter(object, "get_item", None, UnaryOp::Inc)
    }
